    ...
    return (
        <div className="max-w-6xl mx-auto px-6 py-12 grid md:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
                ...
                <p className="text-sm text-gray-500">Shipping is calculated at checkout</p>

                {/* Quantity Selector */}
                <div className="flex items-center space-x-4">
                    <button
                        onClick={decreaseQty}
                        className="border px-3 py-1 rounded text-lg font-semibold"
                    >
                        -
                    </button>
                    ...
                    <button className="bg-teal-600 text-white px-6 py-2 rounded hover:bg-teal-700 transition-all font-semibold ml-4">
                        ADD TO CART
                    </button>
                </div>
